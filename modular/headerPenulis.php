    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
        ...
        <div class="d-flex align-items-center">
          ...
          <a href="../Penulis/BerandaPenulis.php" class="d-block">
    ...
    <div class="container">
      <div class="collapse navbar-collapse">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="Karya.php">Karya</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <div class="sidebar" id="sidebar">
    ...
    <div class="nav flex-column mt-3">
      ...
      <a href="UnggahBuku.php" class="nav-link text-white">
        <i class="bi bi-cloud-arrow-up me-2"></i> Unggah Buku
      </a>
      <a href="Karya.php" class="nav-link text-white">
        <i class="bi bi-collection me-2"></i> Karya
      </a>
    </div>
  </div>
