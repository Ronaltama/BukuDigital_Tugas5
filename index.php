...
<html lang="en">
  ...
  <div class="card book-card shadow-sm h-100">
      <img
        src="img/Buku cover jdul/fiksi/Amba_Laksmi Pamunjak.jpg"
        class="card-img-top"
        alt="Book Cover"
      />
    </a>
      ...
      >
        ...
        <span class="text-muted small">/ Sewa Rp 15.000</span>
              ...
              <div class="col">
                <div class="card book-card shadow-sm h-100">
                  <img
                    src="img/Buku cover jdul/fiksi/Sisi Tergelap Surga_Brian Krisna.jpg"
                    class="card-img-top"
                    alt="Book Cover"
                  />
                  <div class="card-body">
              ...
              <div class="col">
                <div class="card book-card shadow-sm h-100">
                  <img
                    src="img/Buku cover jdul/fiksi/Bulan_Tere Liye.jpg"
                    class="card-img-top"
                    alt="Book Cover"
                  />
                  <div class="card-body">
              ...
              <div class="col">
                <div class="card book-card shadow-sm h-100">
                  <img
                    src="img/Buku cover jdul/fiksi/Cantik itu Luka_Eka Kurniawan.jpg"
                    class="card-img-top"
                    alt="Book Cover"
                  />
                  <div class="card-body">
              ...
              <div class="col">
                <div class="card book-card shadow-sm h-100">
                  <img
                    src="img/Buku cover jdul/fiksi/Dompet Ayah Sepatu Ibu_JS. Khairen.jpg"
                    class="card-img-top"
                    alt="Book Cover"
                  />
                  <div class="card-body">
              ...
              <div class="col">
                <div class="card book-card shadow-sm h-100">
                  <img
                    src="img/Buku cover jdul/fiksi/Gadis Kretek-Ratih Kumala.jpg"
                    class="card-img-top"
                    alt="Book Cover"
                  />
                  <div class="card-body">
              ...
              <div class="col">
                <div class="card book-card shadow-sm h-100">
                  <img
                    src="img/Buku cover jdul/fiksi/Ronggeng Dukuh Paruk_Ahmad Tohari.jpg"
                    class="card-img-top"
                    alt="Book Cover"
                  />
                  <div class="card-body">
              ...
              <div class="col">
                <div class="card book-card shadow-sm h-100">
                  <img
                    src="img/Buku cover jdul/non-fiksi/You do You_Fellexandro Ruby.jpg"
                    class="card-img-top"
                    alt="Book Cover"
                  />
                  <div class="card-body">
          ...
          <div class="col-12 mt-5">
            ...
            <div class="row row-cols-1 row-cols-md-3 row-cols-lg-4 g-4">
              ...
              <div class="col">
                <div class="card book-card shadow-sm h-100">
                  <img
                    src="img/Buku cover jdul/fiksi/Hujan_Tere Liye.jpg"
                    class="card-img-top"
                    alt="Book Cover"
                  />
                  <div class="card-body">
              ...
              <div class="col">
                <div class="card book-card shadow-sm h-100">
                  <img
                    src="img/Buku cover jdul/fiksi/Laskar Pelangi_Andrea Hirata.jpg"
                    class="card-img-top"
                    alt="Book Cover"
                  />
                  <div class="card-body">
              ...
              <div class="col">
                <div class="card book-card shadow-sm h-100">
                  <img
                    src="img/Buku cover jdul/fiksi/Luka Cita_Valerie Patkar.jpg"
                    class="card-img-top"
                    alt="Book Cover"
                  />
                  <div class="card-body">
              ...
              <div class="col">
                <div class="card book-card shadow-sm h-100">
                  <img
                    src="img/Buku cover jdul/fiksi/Retrocession_Ayunita Kuraisy.jpg"
                    class="card-img-top"
                    alt="Book Cover"
                  />
                  <div class="card-body">
          ...
          <div class="col-12 mt-5">
            ...
            <div class="row row-cols-1 row-cols-md-3 row-cols-lg-4 g-4">
              ...
              <div class="col">
                <div class="card book-card shadow-sm h-100">
                  <img
                    src="img/Buku cover jdul/non-fiksi/Filosofi Teras_Henry Manampiring.jpg"
                    class="card-img-top"
                    alt="Book Cover"
                  />
                  <div class="card-body">
               ...
               <div class="col">
                <div class="card book-card shadow-sm h-100">
                  <img
                    src="img/Buku cover jdul/non-fiksi/Insecurity is my Middle Name_Alvi Syahrin.jpg"
                    class="card-img-top"
                    alt="Book Cover"
                  />
                  <div class="card-body">
